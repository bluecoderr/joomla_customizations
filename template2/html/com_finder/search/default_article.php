...
// Creates an array with all the CF of the current article. The true param allows us to get also a rendered value together with the rawvalue
...
<li class="result__item">
    ...
    <ul class="fields-container">
        ...
        if (!empty($articleCustomFields[12]->value)) : ?>
            <li class="field-entry">
                <span class="field-label"><?= $articleCustomFields[12]->label ?>:</span>
                <span class="field-value"><?= $articleCustomFields[12]->value; ?></span>
            </li>
        <?php
        endif; ?>
